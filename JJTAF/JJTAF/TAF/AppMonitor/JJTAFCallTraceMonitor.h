...
@interface JJTAFCallTraceMonitorConfig : NSObject
...
@interface JJTAFCallTraceMonitor : NSObject

+ (void)start:(JJTAFCallTraceMonitorConfig *)config; //开始记录
