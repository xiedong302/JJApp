...
//MARK: - JJTAFCallTraceMonitorConfig
@implementation JJTAFCallTraceMonitorConfig

+ (instancetype)defaultConfig {
    static JJTAFCallTraceMonitorConfig *config;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        config = [[JJTAFCallTraceMonitorConfig alloc] init];
    });
    return config;
}
...
@implementation JJTAFCallTraceMonitor

+ (void)start:(JJTAFCallTraceMonitorConfig *)config {
    if (!config) {
        config = [JJTAFCallTraceMonitorConfig defaultConfig];
    }
